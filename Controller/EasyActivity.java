...
public class EasyActivity extends Activity {
    private ShadeRoomModel mGame = new ShadeRoomModel(1,2);
    ...
    private long totalTime = 4500;
    private boolean timerRunning;
    private int offSet = 0x20000000;
    private DatabaseHelper db = new DatabaseHelper(EasyActivity.this);
    ...
    public int getRandomColor(){
        ...
        return Color.argb(128, rnd.nextInt(150 - 50 + 1) + 50, rnd.nextInt(150 - 50 + 1) + 50, rnd.nextInt(150 - 50 + 1) + 50);
    }
    ...
    private void ShowPopup() {
        ...
        if(mGame.getScore()>db.getEDataScore()) {
            db.updateDataScore(mGame.getScore(),1);
        }
        ...
        butScore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Do Something
                Intent intent = new Intent(EasyActivity.this, ScoreActivity.class);
                startActivity(intent);
                //Close Window
                POPUP_WINDOW_SCORE.dismiss();
            }
