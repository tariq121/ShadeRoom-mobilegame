...
public class MediumActivity extends Activity {
    private ShadeRoomModel mGame = new ShadeRoomModel(2,2);
    ...
    private DatabaseHelper db = new DatabaseHelper(MediumActivity.this);
    ...
    public int getRandomColor(){
        ...
        return Color.argb(128, rnd.nextInt(180 - 130 + 1) + 130, rnd.nextInt(180 - 130 + 1) + 130, rnd.nextInt(180 - 130 + 1) + 130);
    }
    ...
    private void ShowPopup() {
        ...
        if(mGame.getScore()>db.getMDataScore()) {
            db.updateDataScore(mGame.getScore(),2);
        }
